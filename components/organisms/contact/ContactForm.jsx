...
export default function ContactForm() {
    ...
    const handleSubmit = (e) => {
        ...
        setForm({ nombre: "", apellido: "", email: "", telefono: "", comentario: "" })
            ...
            <div className={styles.info}>
                ...
                <form onSubmit={handleSubmit} className={styles.form}>
                    <div className={styles.row}>
                        ...
                        <label style={{ flex: 1 }}>
                            <input name="apellido" value={form.apellido} onChange={handleChange} required placeholder='Apellido' />
                        </label>
                    </div>
                    ...
                    <div className={styles.row}>
                        ...
                        <div className={styles.submitBtn}>
                            <button type="submit" className="btn-custom-primary" disabled={!captchaValue}>Enviar</button>
                        </div>
                    </div>
                </form>
            </div>
